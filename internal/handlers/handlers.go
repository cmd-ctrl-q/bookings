...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	// renew token on login or logout
	...
	// check form has necessary params
	form := forms.New(r.PostForm)
	...
	// store success msg into session
...
// AdminAllReservations shows all reservations in admin too
func (m *Repository) AdminAllReservations(w http.ResponseWriter, r *http.Request) {
	// get list of all reservations in db
	...
	// store data of all new reservations in template
...
func (m *Repository) AdminNewReservations(w http.ResponseWriter, r *http.Request) {
	// get list of new reservations in db
...
func (m *Repository) AdminShowReservation(w http.ResponseWriter, r *http.Request) {
	// explode url and split on /
	exploded := strings.Split(r.RequestURI, "/")
	id, err := strconv.Atoi(exploded[4]) // position 4
	if err != nil {
		helpers.ServerError(w, err)
		return
	}
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	// send admin back to list of reservations
...
func (m *Repository) AdminProcessReservation(w http.ResponseWriter, r *http.Request) {
	// get src and id from uri
	id, _ := strconv.Atoi(chi.URLParam(r, "id"))
	src := chi.URLParam(r, "src")

	err := m.DB.UpdateProcessedForReservation(id, 1)
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Reservation failed to update")
		helpers.ServerError(w, err)
		return
	}
	...
	// take user back from where they came
	http.Redirect(w, r, fmt.Sprintf("/admin/reservations-%s", src), http.StatusSeeOther)
}
...
func (m *Repository) AdminDeleteReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Reservation failed to delete")
		helpers.ServerError(w, err)
		return
	}
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	nextMonth := next.Format("01")       // formatted as 2 digit month
	nextMonthYear := next.Format("2006") // formatted as 4 digit year
	...
	stringMap["next_month_year"] = nextMonthYear // the year for the next month
